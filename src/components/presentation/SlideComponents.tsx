...
export function SlideContent({ title, points, icon }: { title: string; points: string[]; icon: string }) {
  return (
...
export function SlideSignificance() {
  const items = [
...
export function SlideProspects() {
  const items = [
...
export const slideComponents: Record<string, React.FC<Record<string, any>>> = {
  title: SlideTitle,
